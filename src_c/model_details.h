...
strcpy(models[0].model_path,"GMI-models/dense_autoencoder_land.onnx");
printf("model[0] =%s \n",models[0].model_path);
...
strcpy(models[1].model_path,"GMI-models/dense_autoencoder_ocean.onnx");
printf("model[1] =%s \n",models[1].model_path);
